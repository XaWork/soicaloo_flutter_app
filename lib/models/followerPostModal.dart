...
class Post {
  ...
  Post.fromJson(Map<String, dynamic> json) {
    ...
    userId = json['user_id'];
    text = json['text'];
    image = json['image'] != null ? json['image'].cast<String>() : <String>[];
    video = json['video'];
    pdf = json['pdf'];
    ...
    toUser = json['to_user'];
    allImage = json['all_image'] != null
        ? json['all_image'].cast<String>()
        : <String>[];
    ...
    deadData = json['dead_data'] != null
        ? DeadData.fromJson(json['dead_data'], 'dead')
        : null;
    missingData = json['missing_data'] != null
        ? MissingData.fromJson(json['missing_data'], 'missing')
        : null;
...
class DeadData {
  ...
  DeadData.fromJson(Map<String, dynamic> json, String type) {
    id = json['id']?.toString() ?? '';
    postType = type;
